...
function generateMockContracts(teamAbbrev: string): PlayerContract[] {
  ...
  const mockPlayers: Array<{
    ...
    },
    {
      ...
      capHit: 9_500_000,
      years: 4,
      clause: { type: "M-NTC", details: "Modified no-trade clause — can be traded to 10 teams", allowedTeams: ["TOR", "MTL", "VAN", "EDM", "CGY", "OTT", "WPG", "NYR", "BOS", "CHI"] },
    },
    {
    ...
    },
    {
      ...
      capHit: 5_500_000,
      years: 4,
      clause: { type: "M-NTC", details: "Modified NTC — can be traded to 8 teams", allowedTeams: ["FLA", "TBL", "CAR", "NSH", "DAL", "COL", "VGK", "LAK"] },
    },
    {
